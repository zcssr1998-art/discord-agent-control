...
7. full regression `npm test` 266/0 · `npm run check` 95/0 · `npm run smoke:p2` 11/11 · `npm run smoke:p22` 10/10
...
- `PENDING_OWNER_DISCORD_SMOKE` — parent card `打开 Work` / `追加需求` / `Stop`, live `/status` and `/doctor`.
